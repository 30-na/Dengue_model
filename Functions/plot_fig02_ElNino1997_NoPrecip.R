...
plot_Fig2 = function(title1, title2, fun){
    ...
    ggsave(paste0("Figures/fig2_", fun, "1997_NoPrecip.jpg"),
           g,
           height=9,width=9,scale=1)
}

plot_Fig2(title1 = "(A) Annual R0 1997-98 El Nino anomaly (percentage) with respect to the 1950–2020 period (No Precipitation)",
