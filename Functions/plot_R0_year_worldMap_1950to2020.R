...
plot_map = function(var, target_year){
    ...
    g = ggplot(
        ...
        labs(
            title = "Mean Annual R0 Calculated Over the Period 1950–2020)",
            x = "",
            y = ""
        ) +
        facet_wrap(
    ...
    ggsave(paste0("Figures/", var, target_year, "1950.jpg"),
           g,
...
plot_map_diff = function(var, tragetYear, model){
    ...
    g = ggplot(
        ...
        labs(
            title = paste0("Relative R0 Values in ",
                           tragetYear,
                           " Compared to Mean annual R0 Over 1950 to 2020 (",
                           model, 
                           ")"),
            x = "",
            y = "",
    ...
    ggsave(paste0("Figures/", var, tragetYear, "_1950-2020.jpg"),
           g,
