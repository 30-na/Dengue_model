...
country_list = sort(unique(R0$country))
...
print_StandardizedR0 = function(countryList, t){
    ...
    g_y <- ggplot(data = y_long,
        ...
        theme_minimal() +
        labs(title = paste0("Standardized R0 anomalies with respect to 1990-2020 at ", t),
             y = "",
             x = "") +
    ...
    # Print the plots
    ggsave(paste0("Figures/Standardized_R0_", t, ".jpg"),
           g_y,
...
print_StandardizedR0 = function(){
    ...
    g_y <- ggplot(data = y_long,
        ...
        theme_minimal() +
        labs(title = paste0("Standardized R0 anomalies with respect to 1990-2020"),
             y = "",
             x = "") +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1, size = 10, face = "bold")) +
        guides(fill = FALSE)
    ...
    # Print the plots
    ggsave(paste0("Figures/Standardized_R0.jpg"),
           g_y,
           height = 9, width = 7, scale = 1)
