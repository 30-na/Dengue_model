...
CalculateR0 = function(df){
    ...
    mutate(
            ...
            # Alternative R0 Model (quadratic)
...
R0_data2 = merged_data %>%
dplyr::filter(Date >= "1940-01-01" & Date < "1980-01-01") %>%
CalculateR0()
save(R0_data2, file = "processedData/R0_data2.rda")
